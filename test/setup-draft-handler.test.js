...
test("walks the wizard forward and back, persisting each step", async () => {
  ...
  assert.deepEqual(parse(first), { draft: { version: 1, step: "welcome", provider: null, account: null, servers: [], spotify: null, discordEnabled: true, discordIdleBehavior: "clear", discordArtworkLookup: true, startWithWindows: null, hostedEnabled: null, hostedUrl: null }, resumed: false, discarded: false });
