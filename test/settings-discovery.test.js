...
test("caps private network candidates and excludes public and VPN interfaces", () => {
  const hosts = subnetCandidates(() => ({ a: [{ address: "192.168.7.42", family: "IPv4" }], b: [{ address: "10.4.2.18", family: 4 }], c: [{ address: "172.21.1.4", family: 4 }], d: [{ address: "100.64.1.2", family: 4 }], e: [{ address: "8.8.8.8", family: 4 }] }));
