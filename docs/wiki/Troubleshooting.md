...
- **Authentication failed:** check the sign-in on the server's own web interface, then try again. See your provider's page: [Plex](Connect-Plex) · [Jellyfin](Connect-Jellyfin) · [Navidrome](Connect-Navidrome) · [Emby](Connect-Emby).
